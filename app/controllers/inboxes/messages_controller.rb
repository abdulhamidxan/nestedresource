class Inboxes::MessagesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @message.save
        format.html { redirect_to [@inbox, @messages], notice: "Message was successfully created." }
  ...
  def update
    respond_to do |format|
      if @message.update(message_params)
        format.html { redirect_to [@inbox, @messages], notice: "Message was successfully updated." }
